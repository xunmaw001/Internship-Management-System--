        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gongsiPhoto" label="公司logo" prop="gongsiPhoto">
                        <file-upload
                            tip="点击上传公司logo"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.gongsiPhoto" label="公司logo" prop="gongsiPhoto">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="公司成立时间" prop="gongsiChenglishijianTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.gongsiChenglishijianTime"
                                type="datetime"
                                placeholder="公司成立时间"
                                :disabled="ro.gongsiChenglishijianTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gongsiChenglishijianTime" label="公司成立时间" prop="gongsiChenglishijianTime">
                            <span v-html="ruleForm.gongsiChenglishijianTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="公司介绍" prop="gongsiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gongsiContent" label="公司介绍" prop="gongsiContent">
