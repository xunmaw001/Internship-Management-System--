                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.tongzhiPhoto" label="通知图片" prop="tongzhiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.tongzhiPhoto?$base.url+ruleForm.tongzhiPhoto:''"
                            @change="tongzhiPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.tongzhiPhoto" label="通知图片" prop="tongzhiPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.tongzhiPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.tongzhiFile" label="附件" prop="tongzhiFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.tongzhiFile?$base.url+ruleForm.tongzhiFile:''"
                                @change="tongzhiFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.tongzhiFile" label="附件" prop="tongzhiFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.tongzhiFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            tongzhiFileUploadChange(fileUrls){
                this.ruleForm.tongzhiFile = fileUrls;
                this.addEditUploadStyleChange()
            },
