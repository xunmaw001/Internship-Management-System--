                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shixishengguanli/upload/tongzhiMuBan.xls"
                        >批量导入通知数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('tongzhi','导入导出')"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="tongzhiPhoto"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.tongzhiPhoto">
                                <img :src="$base.url+scope.row.tongzhiPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="tongzhiFile"
                                     header-align="center"
                                     width="200"
                                     label="附件">
                        <template slot-scope="scope">
                            <div v-if="scope.row.tongzhiFile">
                                <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+scope.row.tongzhiFile">下载</a>
                            </div>
                            <div v-else>无文件</div>
                        </template>
                    </el-table-column>
