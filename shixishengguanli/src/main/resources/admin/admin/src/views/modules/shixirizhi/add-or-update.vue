    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实习日志编号" prop="shixirizhiUuidNumber">
                       <el-input v-model="ruleForm.shixirizhiUuidNumber"
                                 placeholder="实习日志编号" clearable  :readonly="ro.shixirizhiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实习日志编号" prop="shixirizhiUuidNumber">
                           <el-input v-model="ruleForm.shixirizhiUuidNumber"
                                     placeholder="实习日志编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实习日志标题" prop="shixirizhiName">
                       <el-input v-model="ruleForm.shixirizhiName"
                                 placeholder="实习日志标题" clearable  :readonly="ro.shixirizhiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实习日志标题" prop="shixirizhiName">
                           <el-input v-model="ruleForm.shixirizhiName"
                                     placeholder="实习日志标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="实习日志内容" prop="shixirizhiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shixirizhiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shixirizhiContent" label="实习日志内容" prop="shixirizhiContent">
                            <span v-html="ruleForm.shixirizhiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    xueshengId: '',
                    shixirizhiUuidNumber: new Date().getTime(),
                    shixirizhiName: '',
                    riqiTime: '',
                    shixirizhiContent: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   shixirizhiUuidNumber: [
                              { required: true, message: '实习日志编号不能为空', trigger: 'blur' },
                          ],
                   shixirizhiName: [
                              { required: true, message: '实习日志标题不能为空', trigger: 'blur' },
                          ],
                   riqiTime: [
                              { required: true, message: '日期不能为空', trigger: 'blur' },
                          ],
                   shixirizhiContent: [
                              { required: true, message: '实习日志内容不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `shixirizhi/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.xueshengChange(data.data.xueshengId)
                        _this.ruleForm.shixirizhiContent = _this.ruleForm.shixirizhiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.shixirizhiContent = this.ruleForm.shixirizhiContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`shixirizhi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shixirizhiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
