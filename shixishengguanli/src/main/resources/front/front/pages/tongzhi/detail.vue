<template>
			<view style="margin: 0 30rpx;box-shadow:0 0px 0px 1rpx #a6a6a6">
				...
				<view style="font-weight: bold;font-size: 20upx;margin:0 30rpx 5rpx;"  :style="(detail.tongzhiValue == null || detail.insertTime == null)?'text-align: center;':''">
					<text v-if="detail.tongzhiValue">
						{{detail.tongzhiValue}}
					</text>
					<text :style="detail.tongzhiValue?'float: right':''">
						{{detail.insertTime}}<!-- .split(' ')[0] -->
					</text>
				</view>
				<view style="box-shadow: 0 0  0 1rpx #a6a6a6;margin: 0 30rpx"></view>
                <viwe>
					<image :src="baseUrl+detail.tongzhiPhoto"></image>
                </viwe>
				<view class="content">
					<rich-text :nodes="detail.tongzhiContent"></rich-text>
				</view>
			</view>
