	...
	<view style="">
        <view style="padding: 0 20rpx;width: 100%;margin: 0 auto;;flex-direction: column;flex-wrap: wrap;flex-direction: row;margin-top: 0upx;">
            <view class="list b-b" v-for="(item, index) in list" :key="index" style="width:100%;height: auto;border: 1rps solid #999;margin: 0 auto;background-color: #FFFFFF;margin-top: 10rpx; box-shadow: 0  0 10rpx 0 #999999;border-radius: 25rpx;">
                ...
                <!-- 当前表 -->
                 <view v-show="item.laoshiPhone" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">
                         <text v-if="item.laoshiPhone != null">{{item.laoshiPhone}}</text>
                         <text v-else></text>
                     </text>
                 </view>
                 <view v-show="item.laoshiIdNumber" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     ...
                     <text style="width: 70%">
                         <text v-if="item.laoshiIdNumber != null">{{item.laoshiIdNumber}}</text>
                         <text v-else></text>
                     </text>
                 </view>
                 ...
                 <view v-show="item.laoshiEmail" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">老师邮箱</text>
                     <text style="width: 70%">
                         <text v-if="item.laoshiEmail != null">{{item.laoshiEmail}}</text>
                         <text v-else></text>
                     </text>
                 </view>
            <view style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;font-size: 24rpx;color: #8799A3;">
                ...
                <!--<view v-if="isAuth('laoshi','审核') && item.laoshiYesnoTypes==1" class="" style="display: flex; width: 70%;color: #FFFFFF;">
                ...
                uni.showModal({
                    ...
                    success: async function(res) {
                        if (res.confirm) {
                            ...
                            data.laoshiShenheTime=shijian;
                            await _this.$api.update(`laoshi`, data);
                            _this.hasNext = true
                            // 重置分页参数页数为1
                            _this.mescroll.resetUpScroll()
                        }
