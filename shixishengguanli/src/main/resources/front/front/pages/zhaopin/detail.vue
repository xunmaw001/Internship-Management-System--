			...
			methods: {
                ...
                async submitData() {
                    ...
                    let data = {
                        ...
                        xueshengId: this.user.xueshengId,
				...
				async baoming() {
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								await _this.$api.add('zhaopinToudi', {
									xueshengId: _this.user.id,
									zhaopinId: _this.detail.id,
								});
								_this.$utils.msg('投递成功,请等待审核');
								_this.$utils.jump('/pages/zhaopinToudi/list');
							}
						}
					});
				},
