    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(tongzhi !=null){
            ...
            //级联表 学生
            //级联表
            XueshengEntity xuesheng = xueshengService.selectById(tongzhi.getXueshengId());
            if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody TongzhiEntity tongzhi, HttpServletRequest request){
        ...
        if(false)
            ...
            tongzhi.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<TongzhiEntity> queryWrapper = new EntityWrapper<TongzhiEntity>()
            .eq("xuesheng_id", tongzhi.getXueshengId())
...
//            tongzhi.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        if("".equals(tongzhi.getTongzhiFile()) || "null".equals(tongzhi.getTongzhiFile())){
                tongzhi.setTongzhiFile(null);
        }
...
//                            tongzhiEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
//                            tongzhiEntity.setTongzhiName(data.get(0));                    //通知名称 要改的
//                            tongzhiEntity.setTongzhiPhoto("");//详情和图片
//                            tongzhiEntity.setTongzhiFile(data.get(0));                    //附件 要改的
