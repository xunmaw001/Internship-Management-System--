    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(jianli !=null){
            ...
            //级联表 学生
            //级联表
            XueshengEntity xuesheng = xueshengService.selectById(jianli.getXueshengId());
            if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody JianliEntity jianli, HttpServletRequest request){
        ...
        if(false)
            ...
            jianli.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<JianliEntity> queryWrapper = new EntityWrapper<JianliEntity>()
            .eq("xuesheng_id", jianli.getXueshengId())
            ;
        ...
        if(jianliEntity==null){
            ...
            return R.error(511,"一个人只能有一个简历,不允许有多个");
        }
    }
...
//                            jianliEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
