    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(zhaopinLiuyan !=null){
            ...
            //级联表 学生
            //级联表
            XueshengEntity xuesheng = xueshengService.selectById(zhaopinLiuyan.getXueshengId());
            if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody ZhaopinLiuyanEntity zhaopinLiuyan, HttpServletRequest request){
        ...
        if(false)
            ...
            zhaopinLiuyan.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            zhaopinLiuyanEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
